        ...
        <div class="row m-3 mt-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="/SWP/productall">Product All</a></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <form action="searchprd" method="GET" class="form-inline">
                                <input type="text" class="form-control mr-2" placeholder="Tìm Kiếm Sản Phẩm" name="keyword">
                    ...
                    <div class="row">
                        <c:forEach var="prd" items="${productLists}" varStatus="loop">
                            <div class="col-lg-3 col-md-6 mb-4 product-item">
                                ...
                                <p class="card-text fs-4 text-danger">${prd.price}</p>
